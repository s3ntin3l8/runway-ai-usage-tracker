...
## [2.13.0](https://github.com/s3ntin3l8/runway-ai-usage-tracker/compare/v2.12.0...v2.13.0) (2026-09-26)


### Features

* **antigravity:** add account-merge script for default-&gt;email dedup ([#314](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/314)) ([5247f79](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/5247f79fafcded48bbc33869305202a70fc51e6f))
...
* **collectors/xai:** collect Grok completed-turn usage ([ea97e76](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/ea97e76b63e5926ab30891232853b92346ba51be))
* **collectors/xai:** real cli-chat-proxy collector + OpenCode CLI auto-discovery ([b7ecc88](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/b7ecc889f73d865d88c7d0f05f7221e2bb1792c4))
* **deepseek:** add DeepSeek pay-as-you-go provider (balance card + BYOK retag) ([dae4812](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/dae4812456a167e045f64561b2104579aa6aa9e7))
* **fleet:** manage credential tags + harden per-sidecar scoping ([#322](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/322) follow-ups) ([#324](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/324)) ([ae1e560](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/ae1e560812c3f104ef879023d5c0c30e1952fc75))
* **fleet:** scope credential tag-hints per sidecar ([#319](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/319)) ([#322](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/322)) ([33d8c12](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/33d8c122613d7bbda1333ed834e75d99d004759d))
* **fleet:** surface silent sidecar failures and per-provider identity sources ([#328](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/328)) ([1d5f482](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/1d5f4820ca3f549fb032059cd22608db2c016c92))
* **frontend:** archive providers — hide discontinued providers from dashboard ([#292](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/292)) ([582b431](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/582b431bfd92dde0ddb92e528d5807da4c3d9203))
...
* **minimax:** tag-hint flow for events ([#290](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/290) extension) ([#318](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/318)) ([63a62da](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/63a62da2c1d820104b592baca705c30e902eb321))
* **pricing:** seed xAI/grok per-model rates ([#350](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/350)) ([ceb6d4d](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/ceb6d4d5adad73562f5be9c81b550173d9e9d0d3))
* **sidecar:** .dmg + NSIS installers, branding, rollback, download card and one-click pairing ([#321](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/321)) ([133200c](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/133200c128e398101822f0062a6c89695a00a0ac))
* **sidecar:** extend key-scoped credential origins to OpenCode siblings ([14782a5](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/14782a57ed56eefc2f99b455557c672131d85363)), closes [#349](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/349)
* **sidecar:** fold opencode-ollama events onto the ollama card ([#308](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/308)) ([655d9a2](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/655d9a23ef4d74261a503117c9591d2124f80e86))
* **sidecar:** key-scoped identity for OpenCode CLI credentials ([#348](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/348)) ([0a0f115](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/0a0f1153f877d729ca2bf8a4637471ea606eddf9))
* **sidecar:** opencode CLI auto-discovery for sibling providers + ollama bearer api ([#340](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/340)) ([f4c3780](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/f4c3780c017ceb97f45b7baf1e9fb5f2dd4fbd9d))
* **sidecar:** per-account credential pipeline + server identity hints ([#283](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/283)) ([9759188](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/975918852b38219ce1bbd717abb5bcc1f8a56cb5))
* **sidecar:** server-orchestrated credential tagging (silent listener) ([#290](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/290)) ([69d4dcf](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/69d4dcf03e396c944f094ce022d9aefa87c1607d))
* **webapp:** empty-canvas providers page + multi-account rendering ([#294](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/294)) ([8a7b012](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/8a7b012aef3c97fdcc92ab0124ec1114f179ed66))
* **webapp:** provider setup wizard + clear credentials ([#287](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/287)) ([#295](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/295)) ([7af78fa](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/7af78fa4f3e890ddad0114e3c5c3fd584a63b4c2))
* **webhooks:** per-account thresholds for multi-account providers ([#298](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/298)) ([fcc3989](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/fcc3989ea98e3bfbd1b65fbd7f018970be00dc8c))
...
* **collectors/opencode:** rewrite for console api; debug/raw headers; provider PUT cookie split ([#339](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/339)) ([43fc063](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/43fc0637a9a0928ec4c971136abef931b7b4c760))
* **collectors:** parse redesigned ollama.com settings page; dual-name session cookie ([#330](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/330)) ([6a647f3](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/6a647f351cb90c0d81e22acf597d09a55cd388d5))
* **events:** account-independent event identity; re-attribute on retag instead of double counting ([#326](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/326)) ([07b5269](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/07b52692052c9f48c27e77cdde6d835f4407737e))
* **home:** match archived card size; surface collection failures; purge residual stale health ([61760f7](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/61760f79275ed64ef6d3c77283417bf19bec9132))
* **identity:** one canonical account_id on every write path; stop cross-host identity leaks ([#325](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/325)) ([ae17099](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/ae1709970fe5bc3840ec365df098c7d58ef8aff3))
* keep sidecar credentials with their owners ([#335](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/335)) ([b6c95f7](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/b6c95f78d8d9e105338ca2e1d00ca32c74d29a54))
* **kimi_coding:** mirror dashboard API key into the token cache ([#352](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/352)) ([00385c3](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/00385c3794bc8f6a9d30a0e426e5c37ac0a4752b)), closes [#343](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/343)
...
* preserve explicit account attribution for usage data ([#359](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/359)) ([f3a758e](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/f3a758e737bd5fc081b8b3250428d734ac87d9a6))
* preserve fleet instructions across event batches ([#338](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/338)) ([969695e](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/969695e0a1e688618e568c6751d21ab9151bf596))
* **providers:** add DELETE endpoint for provider-config ([#317](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/317)) ([27bb647](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/27bb6479eb6b0d568e145323d034608bdbdc5a0b))
* **quota:** align stale critical gate on explicit pct_used; add structured collection_failing flag ([791d708](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/791d7082f274a041877d828d929812752cda1c67))
* **registry:** mirror opencode auth.json file rules for openrouter, minimax, kimi_coding ([#355](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/355)) ([39b1ab7](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/39b1ab734f9e6311db962eddd670dea268c0397f)), closes [#351](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/351)
* scope stale gate to pct-bearing cards, add staleness badge ([e660f31](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/e660f31dce4beae2f91801294277bd15c93c27fb))
* scope stale gate to pct-bearing cards, add staleness badge ([e660f31](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/e660f31dce4beae2f91801294277bd15c93c27fb))
* **scripts:** enforce twin-divergence gate, dry-run preview, fallback discovery, e2e test ([#316](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/316)) ([b31917d](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/b31917d098ebf440f733f985d26846b3a03093fb))
* secure sidecar offline queue ([4786dff](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/4786dff6d47d052089f326506dddb079e48a5088))
* **security:** sign /fleet/config; no cross-account credential fallback; opencode pins to cookie owner ([#315](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/315)) ([#327](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/327)) ([31a8e60](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/31a8e60ce8e723ccd7e948b0a054e0e483425944))
* **sidecar:** antigravity raw model wins over used_claude flags ([2df30b6](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/2df30b66459bdd3038494d670ae9f5d3fb93daad))
* **sidecar:** antigravity raw model wins over used_claude flags ([dbcb67f](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/dbcb67f841fc961a292e6c1e2505b95e3ab87e36)), closes [#302](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/302)
* **sidecar:** broaden claude raw match and prefer display over empty-raw flags ([a6f71ad](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/a6f71ad881588bf9df46b1542042e3dbe95e052d))
...
* **sidecar:** map opencode message variant to effort ([#306](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/306)) ([5420c43](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/5420c433459ed7731cb9c0feeb77e3b9c954f855))
* **sidecar:** pass the full path list to anthropic/chatgpt/gemini event parsers ([#323](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/323)) ([af6592e](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/af6592e3a08069b7be214af11ec21dd1832238c0))
* **sidecar:** pin claude raw case handling and name haiku→opus tradeoff ([50f4fa6](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/50f4fa68ec79b3dc79e89ae4aeef7dfc07c7c68e))
* **sidecar:** preserve antigravity model minor versions and capture effort ([#305](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/305)) ([814b826](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/814b826c83121eb35feb06874971333107e2657a))
* **sidecar:** retain queued events on events_error ([#342](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/342)) ([995827b](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/995827bca7aecafbdf33e7f96182f3df0bc0ee2c))
* **test,api:** reload-proof settings patching for manifest tests ([#297](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/297)) ([ec3f97e](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/ec3f97ecc9a50132543b036651a21c49b231395f))
* **token-health:** per-account expiry alerts, invalid status, env-sourced credentials ([#362](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/362)) ([b33c1c8](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/b33c1c8eb547231094dbbd28284cde5b612f0e9c))
* **webapp,api:** mask credential hashes, re-sync detail dialog, and surface discovered provider accounts ([#309](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/309)) ([0392612](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/03926126f449e0cb941661c84f1817e16a951159))
* **webapp:** surface effort badge in events table ([#304](https://github.com/s3ntin3l8/runway-ai-usage-tracker/issues/304)) ([c6d367a](https://github.com/s3ntin3l8/runway-ai-usage-tracker/commit/c6d367a9c608cfec0973e148603c622ac6884704))
