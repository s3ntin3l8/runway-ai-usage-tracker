...
class MockCollector(BaseCollector):
    async def collect(self, client):
        return [{"service": "Mock", "detail": "original", "metadata": {"nested": "value"}}]
...
class TestUtilityResilience:
    def test_extract_token_regex_edge_cases(self):
        ...
        assert extract_token_regex("api_key:key_with_underscores_and-hyphens detail", "api_key:") == "key_with_underscores_and-hyphens"
