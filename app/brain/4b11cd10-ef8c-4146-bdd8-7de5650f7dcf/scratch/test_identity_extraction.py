...
def test_extract_best_email():
    ...
    emails1 = [
        ...
        {
            "email": "58235613+s3ntin3l8@users.noreply.github.com",
            "primary": False,
            "verified": True,
        },
    ]
    ...
    assert (
        IdentityExtractor.extract_best_email(emails3)
        == "58235613+s3ntin3l8@users.noreply.github.com"
    )
    ...
    assert (
        IdentityExtractor.extract_best_email(emails4)
        == "58235613+s3ntin3l8@users.noreply.github.com"
    )
