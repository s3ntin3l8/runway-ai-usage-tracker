...
async def test_label_preservation():
    ...
    if identity:
        ...
        if not collector1.account_label or collector1.account_label.lower() in ("default", "none", "unknown"):
    ...
    if identity:
        if not collector2.account_label or collector2.account_label.lower() in ("default", "none", "unknown"):
