...
async def test_purge():
    ...
    with (
        patch.object(SmartCollector, "collect", return_value=[]),
        patch.object(CredentialProvider, "get_github_data", return_value={"api_key": "mock-token"}),
    ):
    ...
    with (
        ...
        patch.object(GitHubCollector, "_strategy_api", return_value=mock_cards),
    ):
